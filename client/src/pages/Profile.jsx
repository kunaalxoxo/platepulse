...
const Profile = () => {
  ...
  const handleSave = async () => {
    ...
    // Simplistic address string payload (in production, we'd trigger a geocoder for exact lat/lng updates)
    ...
    try {
      ...
      await loadUser(); // Refresh global standard
      setEditing(false);
  ...
  // Safe checks if page mounts before user object resolves deeply
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 pb-20">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        {/* ── Left Column: Edit Profile Block ── */}
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 flex flex-col items-center relative overflow-hidden">
            ...
            {!editing ? (
              ...
              <div className="w-full flex gap-3 mt-8">
                <button onClick={() => setEditing(false)} className="flex-1 p-3 font-bold border-2 border-gray-100 rounded-xl hover:bg-gray-50 transition">Cancel</button>
        ...
        {/* ── Right Column: Impact Stats & Badges ── */}
        <div className="lg:w-2/3 space-y-6">
          ...
          {/* Key Metric Blocks rendered dynamically by Role */}
