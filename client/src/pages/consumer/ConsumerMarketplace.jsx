    ...
    <div className="relative min-h-screen bg-surface">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-text/60">
              {geoStatus === 'granted'
                ? '📍 Showing stores near you · sorted by distance'
                : 'Quality surplus food from local businesses at up to 80% off.'}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 pb-2 flex gap-6 overflow-x-auto hide-scrollbar">
          {[
            { v: '',         l: 'All' },
            { v: 'packaged', l: 'Packaged' },
            { v: 'bakery',   l: 'Bakery' },
            { v: 'produce',  l: 'Fresh Produce' },
            { v: 'cooked',   l: 'Cooked Meals' },
            { v: 'dairy',    l: 'Dairy' },
          ].map(c => (
            <button
              key={c.v}
              ...
              <div key={p._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col group hover:shadow-md transition">
                <div className="relative h-48 bg-gray-50">
                  <img
                    ...
                    alt={p.name}
                    onError={e => { e.target.onerror = null; e.target.src = 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&auto=format'; }}
                  />
