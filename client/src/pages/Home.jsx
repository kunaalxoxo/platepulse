          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="text-left animate-slide-in-right">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {!user && (
                  <Link to="/register?role=donor" className="bg-white text-primary font-black text-base md:text-lg px-8 py-4 rounded-full shadow-xl hover:scale-105 transition-transform text-center whitespace-nowrap">
                    Donate Surplus Food 🍽️
                  </Link>
                )}
                {user && (
                  <Link to="/dashboard" className="bg-white text-primary font-black text-base md:text-lg px-8 py-4 rounded-full shadow-xl hover:scale-105 transition-transform text-center whitespace-nowrap">
                    Go to Dashboard 📊
                  </Link>
                )}
                <Link
                ...
                <Link to="/map" className="border-2 border-white/50 bg-white/10 backdrop-blur-sm text-white font-bold text-base md:text-lg px-8 py-4 rounded-full hover:bg-white/20 transition-all text-center whitespace-nowrap hover:border-white">
                  Explore Live Map 🗺️
                </Link>
              </div>
            </div>
            ...
            <div className="hidden lg:block relative h-[500px]">
              ...
              <div className="absolute rounded-full w-[400px] h-[400px] bg-white/5 blur-3xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0" />
            </div>
          </div>
          ...
          <section className="py-24 px-4 bg-surface">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col sm:flex-row justify-between items-end mb-12 gap-4">
                <div>
                  <h2 className="text-sm font-bold text-orange-500 uppercase tracking-widest mb-2 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" /> Live Right Now</h2>
        ...
        <section className="py-24 px-4 bg-primary text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/demo" className="inline-block border-2 border-white/60 text-white font-black text-lg px-10 py-5 rounded-full hover:bg-white/10 transition-all">▶ Watch Demo</Link>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 font-semibold text-sm">
                ...
                <li><Link to="/demo"        className="hover:text-[#4CAF50] text-[#2E7D32] transition font-bold">▶ View Demo</Link></li>
              </ul>
            </div>
            <div>
