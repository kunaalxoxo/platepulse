...
exports.runSeed = async (req, res) => {
  ...
  try {
    ...
    const donations = await Donation.insertMany([
      { donor: donor1._id, name: 'Hyderabadi Dum Biryani & Mirchi Ka Salan', category: 'cooked',   quantity: 100, quantityUnit: 'portions', aiValidated: true,  aiConfidence: 95, preparedAt: new Date(Date.now()-3600000),  expiresAt: hrs(22), pickupLocation: pt(L.banjara),  status: 'available' },
      { donor: donor2._id, name: 'Osmania Biscuits & Irani Chai Snacks',     category: 'bakery',   quantity: 20,  quantityUnit: 'boxes',    aiValidated: true,  aiConfidence: 87, preparedAt: ago(1),                        expiresAt: hrs(10), pickupLocation: pt(L.jubilee),  status: 'available' },
      { donor: donor1._id, name: 'Paneer Tikka Masala + Butter Naan',        category: 'cooked',   quantity: 45,  quantityUnit: 'portions', aiValidated: true,  aiConfidence: 92, preparedAt: new Date(Date.now()-18000000), expiresAt: hrs(18), pickupLocation: pt(L.banjara),  status: 'available' },
      { donor: donor3._id, name: 'Mixed Vegetables - Tomatoes, Capsicum',    category: 'raw',      quantity: 15,  quantityUnit: 'kg',       aiValidated: true,  aiConfidence: 97,                                            expiresAt: hrs(48), pickupLocation: pt(L.gachi),    status: 'available' },
      { donor: donor2._id, name: 'Parle-G & Good Day Biscuit Packets',       category: 'packaged', quantity: 10,  quantityUnit: 'boxes',    aiValidated: true,  aiConfidence: 99,                                            expiresAt: hrs(72), pickupLocation: pt(L.jubilee),  status: 'available' },
      { donor: donor1._id, name: 'Fresh Paneer & Dahi (Hotel Surplus)',       category: 'dairy',    quantity: 6,   quantityUnit: 'kg',       aiValidated: true,  aiConfidence: 94,                                            expiresAt: hrs(36), pickupLocation: pt(L.banjara),  status: 'available' },
      { donor: donor2._id, name: 'Mutton Haleem & Sheermal',                  category: 'cooked',   quantity: 60,  quantityUnit: 'portions', aiValidated: true,  aiConfidence: 86, preparedAt: new Date(Date.now()-7200000),  expiresAt: hrs(10), pickupLocation: pt(L.jubilee),  status: 'matched',   assignedTo: ngo1._id },
      { donor: donor1._id, name: 'Bagara Baingan + Jowar Roti',              category: 'cooked',   quantity: 80,  quantityUnit: 'portions', aiValidated: true,  aiConfidence: 93, preparedAt: new Date(Date.now()-10800000), expiresAt: hrs(8),  pickupLocation: pt(L.hitech),   status: 'in_transit', assignedTo: vol1._id, pickupConfirmedAt: new Date(Date.now()-1800000) },
      { donor: donor1._id, name: 'Vegetable Pulao & Raita',                  category: 'cooked',   quantity: 70,  quantityUnit: 'portions', aiValidated: true,  aiConfidence: 91, preparedAt: ago(1),                        expiresAt: new Date(ago(1).getTime()+28800000), pickupLocation: pt(L.banjara), status: 'delivered', assignedTo: vol1._id, pickupConfirmedAt: ago(1), deliveryConfirmedAt: new Date(ago(1).getTime()+7200000), ngoRating: 5 },
      { donor: donor2._id, name: 'Dal Makhani & Tandoori Roti',              category: 'cooked',   quantity: 40,  quantityUnit: 'portions', aiValidated: true,  aiConfidence: 89, preparedAt: ago(2),                        expiresAt: new Date(ago(2).getTime()+36000000), pickupLocation: pt(L.jubilee), status: 'delivered', assignedTo: vol2._id, pickupConfirmedAt: ago(2), deliveryConfirmedAt: new Date(ago(2).getTime()+5400000), ngoRating: 4 },
    ...
    const products = await Product.insertMany([
      { retailer: retail1._id, name: 'Amul Taaza Toned Milk 500ml',        category: 'dairy',    mrp: 28,  finalPrice: disc(28,80),  discountPercent: 80, quantity: 40,  expiresAt: hrs(10),  storeLocation: pt(L.banjara), isActive: true,  urgentBadge: true },
      { retailer: retail1._id, name: 'Mother Dairy Paneer Block 200g',     category: 'dairy',    mrp: 68,  finalPrice: disc(68,80),  discountPercent: 80, quantity: 12,  expiresAt: hrs(18),  storeLocation: pt(L.banjara), isActive: true,  urgentBadge: true },
      { retailer: retail1._id, name: 'Britannia Whole Wheat Bread 400g',   category: 'bakery',   mrp: 48,  finalPrice: disc(48,70),  discountPercent: 70, quantity: 55,  expiresAt: hrs(36),  storeLocation: pt(L.banjara), isActive: true,  urgentBadge: false },
      { retailer: retail2._id, name: 'English Oven Multigrain Bread 500g', category: 'bakery',   mrp: 58,  finalPrice: disc(58,70),  discountPercent: 70, quantity: 20,  expiresAt: hrs(42),  storeLocation: pt(L.gachi),   isActive: true,  urgentBadge: false },
      { retailer: retail1._id, name: 'Epigamia Greek Yogurt Mango 90g',    category: 'dairy',    mrp: 35,  finalPrice: disc(35,40),  discountPercent: 40, quantity: 70,  expiresAt: hrs(72),  storeLocation: pt(L.banjara), isActive: true,  urgentBadge: false },
      { retailer: retail2._id, name: 'Organic Fresh Methi Bunch',          category: 'produce',  mrp: 25,  finalPrice: disc(25,40),  discountPercent: 40, quantity: 30,  expiresAt: hrs(60),  storeLocation: pt(L.gachi),   isActive: true,  urgentBadge: false },
      { retailer: retail2._id, name: 'Cherry Tomatoes Punnet 250g',        category: 'produce',  mrp: 50,  finalPrice: disc(50,20),  discountPercent: 20, quantity: 18,  expiresAt: hrs(80),  storeLocation: pt(L.gachi),   isActive: true,  urgentBadge: false },
      { retailer: retail1._id, name: 'Aashirvaad Multigrain Atta 1kg',     category: 'grocery',  mrp: 62,  finalPrice: disc(62,20),  discountPercent: 20, quantity: 45,  expiresAt: hrs(120), storeLocation: pt(L.banjara), isActive: true,  urgentBadge: false },
      { retailer: retail2._id, name: 'Tata Rock Salt 1kg',                 category: 'grocery',  mrp: 24,  finalPrice: disc(24,20),  discountPercent: 20, quantity: 100, expiresAt: hrs(144), storeLocation: pt(L.gachi),   isActive: true,  urgentBadge: false },
      { retailer: retail1._id, name: 'Paper Boat Aam Panna Juice 250ml x4',category: 'beverage', mrp: 80,  finalPrice: disc(80,20),  discountPercent: 20, quantity: 30,  expiresAt: hrs(300), storeLocation: pt(L.banjara), isActive: true,  urgentBadge: false },
      { retailer: retail2._id, name: 'Amul Gold Butter 100g',              category: 'dairy',    mrp: 58,  finalPrice: disc(58,70),  discountPercent: 70, quantity: 15,  expiresAt: hrs(50),  storeLocation: pt(L.gachi),   isActive: true,  urgentBadge: true },
      { retailer: retail1._id, name: 'Nestle Dahi 400g Cup',               category: 'dairy',    mrp: 45,  finalPrice: disc(45,80),  discountPercent: 80, quantity: 25,  expiresAt: hrs(8),   storeLocation: pt(L.banjara), isActive: true,  urgentBadge: true },
    ]);
    ...
    await CommunityShare.insertMany([
      { postedBy: consumer1._id, name: 'Homemade Hyderabadi Double Ka Meetha',          category: 'cooked',  quantity: 8,  location: pt(L.hitech),   claimedByLimit: 4, claimedCount: 0, expiresAt: hrs(12), isActive: true },
      { postedBy: consumer2._id, name: 'Extra Khichdi & Pickle from Home (Amma Made)',  category: 'cooked',  quantity: 10, location: pt(L.jubilee),  claimedByLimit: 5, claimedCount: 2, expiresAt: hrs(6),  isActive: true },
      { postedBy: donor3._id,   name: 'Garden-grown Curry Leaves & Green Chillies',    category: 'produce', quantity: 4,  location: pt(L.gachi),    claimedByLimit: 4, claimedCount: 1, expiresAt: hrs(36), isActive: true },
      { postedBy: consumer1._id, name: 'Fresh Banganapalli Mangoes from Our Farm',      category: 'produce', quantity: 15, location: pt(L.hitech),   claimedByLimit: 3, claimedCount: 3, expiresAt: hrs(24), isActive: false },
      { postedBy: consumer2._id, name: 'Leftover Qubani Ka Meetha (Eid Celebration)',   category: 'cooked',  quantity: 5,  location: pt(L.jubilee),  claimedByLimit: 3, claimedCount: 0, expiresAt: ago(1),  isActive: false },
    ]);
    ...
    return res.status(200).json({
      ...
      summary: { users: 14, donations: 12, missions: 5, products: 12, orders: 3, communityShares: 5, wasteRequests: 3, impactLogs: 9 },
      testAccounts: {
